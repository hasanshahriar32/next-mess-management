...
const ManageDevelopers = () => {
  ...
  useEffect(() => {
    try {
      const user = async () => {
        const user =
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY0NDJhNzM5MWQ5YzZhZDZiNzVlYTFiMyIsImlhdCI6MTY5MjgxNTYxMCwiZXhwIjoxNjk1NDA3NjEwfQ.QmyTHr_5S8oIMphOpbiJLQvx7gZWEq0BA0m0BE3URP4";
        const config = {
          headers: {
  ...
  const handleAdd = async (e) => {
    ...
    const data = {
      ...
      adminmaker: "6442a7391d9c6ad6b75ea1b3",
    };
    // console.log(data);
    try {
      const user =
  ...
  //   const data = {
  //     adminterminator: "6442a7391d9c6ad6b75ea1b3",
  //     adminterminatorpass: e.target.confirmRemove.value,
  //   };
  //   // console.log(data);
  //   try {
  //     const user = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY0NDJhNzM5MWQ5YzZhZDZiNzVlYTFiMyIsImlhdCI6MTY5MjgxNTYxMCwiZXhwIjoxNjk1NDA3NjEwfQ.QmyTHr_5S8oIMphOpbiJLQvx7gZWEq0BA0m0BE3URP4";
  //     const config = {
  //       headers: {
  //         Authorization: `Bearer ${user}`,
  //       },
  ...
  const handleRemove = async (e) => {
    ...
    const adminterminator = "6442a7391d9c6ad6b75ea1b3";
    const jwtToken =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY0NDJhNzM5MWQ5YzZhZDZiNzVlYTFiMyIsImlhdCI6MTY5MjgxNTYxMCwiZXhwIjoxNjk1NDA3NjEwfQ.QmyTHr_5S8oIMphOpbiJLQvx7gZWEq0BA0m0BE3URP4";
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center lg:w-[950px]">
      {admin.length == 0 ? (
        <span className="loading text-info loading-bars loading-lg"></span>
      ) : (
        <section class="p-3 sm:p-5">
          <div class="mx-auto  max-w-screen-xl px-2 lg:px-4">
            {/* <!-- Start coding here --> */}
            <ToastContainer></ToastContainer>
            <div class="0 relative shadow-md sm:rounded-lg overflow-hidden">
