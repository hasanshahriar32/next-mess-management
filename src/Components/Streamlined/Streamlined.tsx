...
export const StreamlinedExperience = () => {
  ...
  return (
    ...
    >
      <motion.div
        style={{ position }}
        className="top-1/2 left-1/2 min-h-[40rem] min-w-[40rem] -translate-x-1/2 -translate-y-1/2 whitespace-nowrap before:absolute before:inset-0 before:scale-[var(--scale)] before:border-[2.5rem] before:border-warning before:opacity-[var(--opacity-border)]"
      >
        <motion.p
          aria-hidden
          style={{ x: textX, y: "-50%" }}
          className="whitepspace-nowrap min-w-screen absolute top-1/2 left-[calc(-50vw+25rem)] text-[15rem] text-heading"
        >
          Mess Management?
        </motion.p>
        <motion.p
        ...
        <motion.p
          ...
          className="absolute left-1/2 top-1/2 text-[5.8rem] leading-tight text-grey-200"
        >
          Enhanced
          <br />
          Solution.
        ...
        <span className="absolute left-[calc(50%*var(--scale)+50%-(2.5rem*var(--scale)))] top-0 z-[12] h-full w-[50vw] origin-left scale-[var(--scale)] border-l-[2.5rem] border-warning opacity-[var(--opacity-border)]" />
      </motion.div>
    </motion.section>
  );
};
